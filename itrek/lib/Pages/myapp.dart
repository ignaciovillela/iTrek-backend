...
class _HomePageState extends State<HomePage>
  ...
  void initState() {
    ...
    // Inicializar el AnimationController antes de la animación
    _animationController = AnimationController(
      vsync: this,
      duration: const Duration(seconds: 1),
    )..repeat(reverse: true); // Repetir la animación

    // Inicializar la animación después del AnimationController
  ...
  @override
  void dispose() {
    _animationController.dispose(); // Liberar recursos de la animación
    super.dispose();
  }
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.translate(
                      offset:
                          Offset(0, -_animation.value), // Animación de salto
                      child: Image.asset(
